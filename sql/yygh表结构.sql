...
CREATE
DATABASE IF NOT EXISTS `yygh_cmn` CHARACTER SET utf8;
USE
`yygh_cmn`;
...
CREATE
DATABASE IF NOT EXISTS `yygh_order` CHARACTER SET utf8;
USE
`yygh_order`;
...
CREATE
DATABASE IF NOT EXISTS `yygh_user` CHARACTER SET utf8;
USE
`yygh_user`;
